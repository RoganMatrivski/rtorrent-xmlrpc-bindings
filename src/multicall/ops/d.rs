...
d_op_const!(BASE_FILENAME, String, "base_filename");
d_op_const!(BASE_PATH, String, "base_path");
d_op_const!(DIRECTORY, String, "directory");
d_op_const!(DIRECTORY_BASE, String, "directory_base");
d_op_const!(
...
d_op_const!(
    /// Is the download currently hash-checking?
    IS_HASH_CHECKING,
    bool,
    "is_hash_checking"
);
...
d_op_const!(IS_PRIVATE, bool, "is_private");
d_op_const!(
